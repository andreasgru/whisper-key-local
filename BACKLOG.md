...
- [ ] Rest-Abnahme am Mac (nur noch: Hotkeys drücken, Auto-Paste am Cursor, Wake Word per echter Stimme, Overlay sichtbar) — Checkliste: `doc/plans/active/2026-07-02-macos-abnahme.md` (lokal, nicht im Repo)
- [ ] Nach Abnahme: `feature/macos-port` → neuer `local_master` (enthält auch Windows-relevante Fixes: Wake-Word-Pre-Roll, ten-vad-Hops, log_transcriptions). Alter Windows-Stand bleibt via Tag `pre-upstream-merge-20260702` erreichbar
